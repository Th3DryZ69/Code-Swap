...
- go 'Select Range' > First Address: ```7264C0``` > Last Address: ```7266F0``` and Select
...
- go 'Select Range' > First Address: ```7266F0``` > Last Address: ```726955``` and Select
...
## Step 9) White Copy:
- go 'Select Range' > First Address: ```7254C3``` > Last Address: ```72568B``` and Select
