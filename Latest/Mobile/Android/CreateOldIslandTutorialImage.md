...
- path pak : Android > data > com.epicgames.fortnite > files > GFP_BaseInstallRoot > Startup > Content > Paks > pakchunk30-Android_ASTCClient.ucas
...
## Step 3)
- go 'Select Range' > First Address: ```2C0C160``` > Last Address: ```2C0C6D0``` and Select
